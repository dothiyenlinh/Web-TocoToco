<%@ Page Title="" Language="C#" MasterPageFile="~/LoginMaster.Master" AutoEventWireup="true" CodeBehind="DangKy.aspx.cs" Inherits="WebCuoi.DangKy" %>
            ...
            <table class="auto-style1" style="border: thin solid #008000">
                ...
                <tr>
                    ...
                    <td class="auto-style13">
                        <asp:TextBox ID="txtdn" runat="server" Height="29px" Width="181px" BackColor="#999966" CssClass="auto-style18"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td class="auto-style13">
                        <asp:TextBox ID="txtmatkhau" runat="server" TextMode="Password" Height="29px" Width="181px" BackColor="#999966" CssClass="auto-style18"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td class="auto-style13">
                        <asp:TextBox ID="txtnhaplai" runat="server" TextMode="Password" Height="29px" Width="181px" BackColor="#999966" CssClass="auto-style18"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td class="auto-style13">
                        <asp:TextBox ID="txthoten" runat="server" Height="29px" Width="181px" BackColor="#999966" CssClass="auto-style18"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td class="auto-style13">
                        <asp:TextBox ID="txtngaysinh" runat="server" TextMode="Date" Width="181px" Height="29px" BackColor="#999966" CssClass="auto-style18"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td class="auto-style13">
                        <asp:TextBox ID="txtDiaChi" runat="server" Height="29px" Width="181px" BackColor="#999966" CssClass="auto-style18"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style10">Email</td>
                    <td class="auto-style13">
                        <asp:TextBox ID="txtmail" runat="server" Height="29px" Width="181px" BackColor="#999966" CssClass="auto-style18"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td class="auto-style14">
                        <asp:TextBox ID="txtSoDT" runat="server" Height="29px" Width="181px" BackColor="#999966" CssClass="auto-style18"></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style15">
                        <br />
                        <asp:Button ID="btndangky" runat="server" Text="Đăng ký" BackColor="#006600" Height="41px" Width="101px" OnClick="btndangky_Click" ForeColor="White" />
                        <br />
                        <br />
